    ...
    <>
      ...
      >
        ...
        >
          ...
          <Typography variant="h6">
            Passionate About Cloud, Micro Frontends, and DevOps Automation.
          </Typography>
        </Box>
        <Avatar
          src={myImage}
          sx={{ mt: "30px", width: "300px", height: "300px" }}
        />
        <Box
          sx={{
            mt: "30px",
        ...
        >
          ...
          <Typography variant="body1" sx={{ fontWeight: "bold" }}>
            I am an experienced Cloud Engineer specializing in Micro Frontend
            Architecture and Reusable Component Design.
          </Typography>
          <Typography variant="body1" sx={{ fontWeight: "bold" }}>
            With expertise in ReactJS, TypeScript, and GraphQL, I build seamless
            and scalable user interfaces while leveraging Golang for backend
            development.
          </Typography>
          <Typography variant="body1" sx={{ fontWeight: "bold" }}>
            My strong background in AWS, Kubernetes, Docker, and Helm enables me
            to develop and deploy cloud-native applications efficiently.
          </Typography>
        </Box>
        <Box
          sx={{
      ...
      >
        ...
        <Typography variant="body2">
          © 2025 Yugandhar Pathi. All rights reserved.
        </Typography>
      </Box>
